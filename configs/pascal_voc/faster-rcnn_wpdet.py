_base_ = [
    '../_base_/models/faster-rcnn_wpdet.py',
...
# by lyz
optim_wrapper = dict(
   type='WpdetOptimWrapper',
   optimizer=dict(type='WpDet', rho=1, gamma=0.1, adaptive=True, base_optimizer='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001))
