_base_ = [
    '../_base_/models/faster-rcnn_resdet.py',
...
# by lyz
optim_wrapper = dict(
   type='ResOptimWrapper',
   optimizer=dict(type='ResDet', rho=0.5, gamma=0.5, adaptive=True, base_optimizer='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001))
